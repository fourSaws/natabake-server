    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('brand', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='brand_serializer', to='Cigarettes.modelbrand', verbose_name='Бренд')),
                ('category', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='Cigarettes.modelcategory', verbose_name='Категория')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.CharField(max_length=255, verbose_name='Адрес')),
                ('status', models.CharField(choices=[('IN_CART', 'В корзине'), ('WAITING_FOR_PAYMENT', 'Ожидает оплаты'), ('PAID', 'Оплачено'), ('CASH', 'Наличные')], max_length=255, verbose_name='Статус заказа')),
                ('comment', models.CharField(blank=True, max_length=500, null=True, verbose_name='Комментарий')),
                ('client', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Cigarettes.modeluser', verbose_name='Чат ID клиента')),
            ],
            options={
                'verbose_name': 'Заказ',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='products', to='Cigarettes.modelproduct', verbose_name='ID в каталоге')),
            ],
            options={
